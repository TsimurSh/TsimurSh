...
public class TestEmployee {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Emloyee> listOFEmp = new ArrayList<>();
        ...
        test1.filtrationEmployee(listOFEmp, empl -> empl.department.equals("IT") && empl.salary > 200);
        test1.filtrationEmployee(listOFEmp, empl -> {
            return empl.name.equals(empl.department);
        });
        test1.filtrationEmployee(listOFEmp, empl -> empl.name.startsWith("A") && empl.salary < 450);
